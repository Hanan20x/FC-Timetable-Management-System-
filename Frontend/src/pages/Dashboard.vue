...
import { getScheduleForUser, rooms, subjects, lecturers, students, days, timeSlots } from '../data/mockData.js'
import { detectConflicts } from '../data/analytics.js'
...
const conflictCount = computed(() => detectConflicts().length)
